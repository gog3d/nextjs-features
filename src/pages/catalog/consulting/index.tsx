...
const Consulting: FC <IConsultingProps> = ({ catalog, contacts }) => {
  ...
  return (
    <>
      <MediaQuery minWidth={800}>
        {
          (matches) => matches ? 
            <CatalogPage catalog={catalog} contacts={contacts}  initialType={'consulting'}/>
             :
            <ConsultingPageMobile catalog={catalog}/>
        }
      </MediaQuery>
    </>
  ) 
