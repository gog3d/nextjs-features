...
const MayonnaiseSauce: FC <IMayonnaiseSauceProps> = ({ catalog, contacts }) => {
  ...
  return (
    <>
      <MediaQuery minWidth={800}>
        {
          (matches) => matches ? 
            <CatalogPage catalog={catalog} contacts={contacts}  initialType={'mayonnaise-sauce'}/>
             :
            <MayonnaiseSaucePageMobile catalog={catalog}/>
        }
      </MediaQuery>
    </>
  ) 
