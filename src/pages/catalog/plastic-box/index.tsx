...
const PlasticBox: FC <IPlasticBoxProps> = ({ catalog, contacts }) => {
  ...
  return (
    <>
      <MediaQuery minWidth={800}>
        {
          (matches) => matches ? 
            <CatalogPage catalog={catalog} contacts={contacts}  initialType={'plastic-box'}/>
             :
            <PlasticBoxPageMobile catalog={catalog}/>
        }
      </MediaQuery>
    </>
  ) 
