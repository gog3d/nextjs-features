...
interface ICartonPackagingPageMobileProps {
  catalog: Array<TCatalogItemsTypes>;
}

const CartonPackagingPageMobile: FC<ICartonPackagingPageMobileProps> = ({catalog}) => {
...
export default CartonPackagingPageMobile;
